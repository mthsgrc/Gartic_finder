...
threeLetterBtn.addEventListener("click", function() {
    let threeLetters = wordLengthFilter( arrayWordList, 3);
    printWord(threeLetters);
});


fourLetterBtn.addEventListener("click", function() {
    let fourLetters = wordLengthFilter( arrayWordList, 4);
    printWord(fourLetters);
});


fiveLetterBtn.addEventListener("click", function() {
    let fiveLetters = wordLengthFilter( arrayWordList, 5);
    printWord(fiveLetters);
});
